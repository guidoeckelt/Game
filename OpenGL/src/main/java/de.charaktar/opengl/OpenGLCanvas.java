...
//        glAutoDrawable.setGL(new DebugGL(gl));
    ...
    private void createEarthTexture(GLProfile glProfile) {
        try {
            ...
            InputStream stream2 = new FileInputStream("D:\\DevGame\\PointyAndClicky\\OpenGL\\src\\main\\resources\\texture\\Earth.png");
...
//        earthTexture.bind(gl);
        ...
        glu.gluQuadricDrawStyle(earth, GLU.GLU_FILL); // possible show styles: FILL, LINE, POINT
