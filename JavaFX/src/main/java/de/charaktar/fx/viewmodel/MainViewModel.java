package de.charaktar.fx.viewmodel;

import de.charaktar.fx.input.FxKeyBoard;
import de.charaktar.fx.input.FxMouse;
...
public class MainViewModel {
    ...
    public MainViewModel(Stage primaryStage, Class gameClass) {
    ...
    public void startGame() throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
        Mouse mouse = new FxMouse(this.mainWindow);
        KeyBoard keyBoard = new FxKeyBoard(this.mainWindow);
        Speaker speaker = new Speaker();
        if (this.gameClass != null) {

            this.game = (Game) this.gameClass.getConstructor(Mouse.class, KeyBoard.class, Speaker.class).newInstance(mouse, keyBoard, speaker);
            this.game.start();
        }
    }
