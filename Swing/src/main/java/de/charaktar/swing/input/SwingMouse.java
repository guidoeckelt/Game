...
import de.charaktar.ge.input.MouseButton;
...
public class SwingMouse implements Mouse {
    ...
    private List<de.charaktar.ge.input.MouseListener> listenerList;
    ...
    @Override
    public void addListener(de.charaktar.ge.input.MouseListener listener) {
        this.listenerList.add(listener);
    }

    @Override
    public void removeListener(de.charaktar.ge.input.MouseListener listener) {
