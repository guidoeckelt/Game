...
public class SwingMouse implements Mouse {
    ...
    private List<de.charaktar.ge.inputoutput.MouseListener> listenerList;
...
//        System.out.println("mouse = "+ posX +" : "+ posY);
    ...
    private void updateListeners() {
        de.charaktar.ge.inputoutput.MouseEvent event = new de.charaktar.ge.inputoutput.MouseEvent(new Vector(posX, posY), this.buttonsPressed);
        for (de.charaktar.ge.inputoutput.MouseListener listener : listenerList) {
